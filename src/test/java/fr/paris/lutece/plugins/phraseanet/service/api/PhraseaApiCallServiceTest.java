...
{
    private static final String RESPONSE = "{ \"meta\": { " + "\"api_version\": \"1.0\"," +
        " \"request\": \"GET /api/v1/feeds/288/content/\"," + "  \"response_time\": \"2011-07-27T15:52:04+02:00\"," +
        "  \"http_code\": 200," + "  \"error_message\": null," + "  \"error_details\": null," +
        "  \"charset\": \"UTF-8\"" + "}," + "\"response\": {" + "\"body\":\"response body\"" + "} }";
