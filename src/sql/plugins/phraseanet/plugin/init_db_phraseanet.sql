...
INSERT INTO phraseanet_media (id_media, media_name, media_description, url_icon, insert_template, media_type, bases, default_width, default_height) 
VALUES (2,'Vidéo','Vidéos','images/admin/skin/plugins/phraseanet/video_icon.png', '<object id="home" width="${width}" height="${height}" data="plugins/phraseanet/flowplayer/flowplayer-3.2.7.swf" type="application/x-shockwave-flash"> <param name="movie" value="plugins/phraseanet/flowplayer/flowplayer-3.2.7.swf" /> <param name="allowfullscreen" value="true" /> <param name=autoplay value=false> <param name="flashvars" value=config={"clip":"${url}"} /></object>', 'video', NULL, 400, 300);
INSERT INTO phraseanet_media (id_media, media_name, media_description, url_icon, insert_template, media_type, bases, default_width, default_height) 
